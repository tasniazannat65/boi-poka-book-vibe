...
const ReadListShow = ({book}) => {
    ...
    return (
       <div className='flex flex-col lg:flex-row  items-center gap-10 border border-[#13131326] rounded-2xl p-6 mt-5'>
     <div className=' flex justify-center items-center w-[230px] h-[229px]  bg-[#1313130d] rounded-2xl '>
       <img className=' w-[129px] h-[172px] ' src={image} alt="" />
            ...
            <div className=' space-y-5 flex-1'>
                ...
                <div className='flex flex-col lg:flex-row items-start lg:items-center lg:space-x-3 space-x-0 space-y-2 lg:space-y-0'>
            ...
            <button className='text-[#328EFF] work-sans btn bg-[#328eff26] rounded-[30px] p-3 lg:px-[20px] lg:py-[11px]'>Category: {category}</button>
            <button className='btn  work-sans  bg-[#ffac3326] text-[#FFAC33] rounded-[30px] p-3 lg:px-[20px] lg:py-[11px] '>Rating: {rating}</button>
            <button className='btn bg-[#23BE0A] text-white rounded-[30px] p-3 lg:px-[20px] lg:py-[11px] work-sans text-lg font-medium'>View Details</button>
           </div>               
